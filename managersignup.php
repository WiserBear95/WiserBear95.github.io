...
<!--Reference Code-projects.org/Sourcecodeandprojects-->
  <head>
    <title> Manager Signup | The Leaping Salmon </title>
  </head>
...
<!--displays text-->
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> The Leaping Salmon </span></h1>
     <br>
...
<!--Creates account creation form-->
 ...
 <!--Directs user to login-->
  ...
  <br>
  <p> The Leaping Salmon| &copy All Rights Reserved </p>
  <br>
  </footer>
</html>