...
<html>
  ...
  <head>
    <title> Cart | The Leaping Salmon </title>
  </head>
...
<?php
  ...
  ?><!-- If not a manager set user as customer-->
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Menu </a></li>
            <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> Your Order
             (<?php
...
<h2 class="text-center"> Thank you for Ordering at The Leaping Salmon! The ordering process is now complete.</h2>
