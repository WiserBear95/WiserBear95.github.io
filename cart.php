...
<?php
  ...
  ?> <!-- If not a manager set user as customer-->
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-shopping-cart"></span> Your Order
             (<?php
...
<!-- Sets code for if there are no items in the cart-->
<?php
}
if(empty($_SESSION["cart"]))
{
