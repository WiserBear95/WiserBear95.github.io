...
(58, 'Guinness', 5, 'Guinness has a malty sweetness and a hoppy bitterness, with notes of coffee and chocolate.', 1, 'images/Guinness.jpg', 'ENABLE'),
(59, 'Murphys', 5, 'Murphy’s is dark in color and medium-bodied. It is silky smooth with toffee & coffee undertones, almost no bitterness, and a irresistible creamy finish.', 2, 'images/Murphys.png', 'ENABLE'),
(60, 'Beamish', 4, 'The taste has flavors of dry, roasted malts and a light amount of bitterness.', 3, 'images/Beamish.png', 'ENABLE'),
(61, 'Heineken', 6, ' Light bodied but with good malty cereal and banana chew fruity yeast. Great balance between fruit and hop bitterness.', 1, 'images/Heineken.png', 'ENABLE'),
(62, 'Carlsberg', 6, ' brewed on lager malt, a slightly roasted, bright type of malt which results in the well-known mild, fresh taste and aroma of flowers and grain.', 2, 'images/Carlsberg.png', 'ENABLE'),
(63, 'Coors', 6, 'Coors Light is an American-style light lager beer.', 3, 'images/Coors.png', 'ENABLE'),
(65, 'Lagunitas', 7, 'An intense hop juiciness, with white wine, gooseberry, lemon grass, pineapple, melon.', 4, 'images/Lagunitas.png', 'DISABLE'),
(66, 'Smirnoff', 5, 'Describing the flavor of vodka is very tough', 4, 'images/Vodka.png', 'DISABLE'),
(68, 'Gordans', 6, 'Sweet notes of juniper, a little lemon zest, hints of soft sweetness and fresh herbs. Palate: Very clean, dry juniper delivery, develops with lemon and other citrus notes ', 6, 'images/Gin.png', 'DISABLE'),
(69, 'Bacardi', 6, 'The nose is light and fresh with a little spice and pepper, quite spirity.', 2, 'images/Rum.jpg', 'ENABLE'),
