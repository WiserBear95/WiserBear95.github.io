...
<html>
<head>
    <title> Guest Signup | 	The Leaping Salmon </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">The Leaping Salmon</a>
        </div>
...
<!--Sets text-->
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> The Leaping Salmon </span></h1>
     <br>
...
<!-- Sets form for Creating account-->
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <!-- Sets Textbox for users contact info -->
        <div class="row">
          <div class="form-group col-xs-12">
      ...
      <!-- Sets Textbox for users address  -->
        <div class="row">
          <div class="form-group col-xs-12">
      ...
      <!-- Sets Textbox for users password -->
        <div class="row">
          <div class="form-group col-xs-12">
      ...
      <!-- Sets Button to submit create account  -->
        <div class="row">
          <div class="form-group col-xs-4">
              <button class="btn btn-primary" type="submit">Submit</button>
          </div>
<!-- Sets button to direct user back to login page-->
        </div>
